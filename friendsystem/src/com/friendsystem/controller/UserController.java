...
public class UserController
{
    ...
    public void attentionUser(@ModelAttribute("session") User userSession, Model model,
    ...
    public ModelAndView whoPeople(@ModelAttribute("session") User userSession, Model map,
                                  String user_Id,
    ...
    private ModelAndView basicSetting(@ModelAttribute("session") User userSession, Model model,
                                      String textName, HttpServletRequest request,
                                      HttpServletResponse response, MultipartFile pictureFile,
                                      MultipartFile weCate, String your, String sex)
        throws IOException
    {
        ModelAndView modelAndView = new ModelAndView();
        String imgPath = "";
        ...
        User userNewSession = userService.updateBasic(textName, imgPath, userSession, imgPath2,
            sex, your);
    ...
    public void personalData(@ModelAttribute("session") User userSession, Model model,
                             String user_Id, HttpServletRequest request,
                             HttpServletResponse response)
        throws IOException
    {
    ...
    public ModelAndView createArticle(@ModelAttribute("session") User userSession, Model model,
                                      String titleName, String content, MultipartFile pictureFile,
    ...
    public ModelAndView releaseArticle(@ModelAttribute("session") User userSession, Model model,
                                       String titleName, String content, MultipartFile pictureFile,
                                       HttpServletRequest request, HttpServletResponse response,
                                       String article_Id)
        throws IOException
     ...
     */
    @RequestMapping("fans")
    public ModelAndView fans(@ModelAttribute("session") User userSession, Model model)
    {
        ModelAndView modelAndView = new ModelAndView();
        List<User> listFans = userService.findFansBy(userSession);
        modelAndView.addObject("listFans", listFans);
        return modelAndView;
