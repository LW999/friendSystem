...
public class TestWeiWei {
	...
	public void dsdas() {
		String dString = RemoveHTML.Html2Text("<p>使用 base64 保存图片</p><p style=\"text-align: center;\">\r\n"
				...
				+ "									<td>&nbsp;</td>\r\n" + "								</tr>\r\n"
				+ "							</tbody>\r\n"
				+ "						</table><p><span style=\"font-size: xx-large;\">d'sa</span></p><p><span style=\"font-size: xx-large;\">爱上帝啥的hi哦等候i阿斯活动i啊是 大神都ii阿什顿等候i阿史都ii撒谎&nbsp;</span></p>",
				99999999);
	...
	public void faskjsa() {
		...
		listCommentDTO = homeService.getComment("5768");
		System.out.println("XIE:" + listCommentDTO.get(0).getListCommentDTO().size());
		System.out.println("XIE:" + listCommentDTO.get(1).getListCommentDTO().size());

	}
	@Test
	public void dhsah() {
		List<CommentDTO> listCommentDTO = new ArrayList<>();
		listCommentDTO = homeService.getComment("5867");
		System.out.println(""+listCommentDTO);
	}
