...
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/entry-dc1e51fe2b436e18f5ee.css" />
	...
	<div class="container setting">
		<div class="row">
			...
			<div class="col-xs-16 col-xs-offset-8 main">
				<form action="${pageContext.request.contextPath }/user/basic.do" method="post" enctype="multipart/form-data">
					<table>
						<thead>
							<tr>
						...
						<tbody class="base">
							<tr>
								<td class="top-line">
									<div class="avatar">
										<img src="${pageContext.request.contextPath}/img/user.do?fileFileName=${sessionScope.session.userPortrait }" id="selectImg">
									</div>
								</td>
								<td class="top-line">
									<a class="btn btn-hollow">
										<input unselectable="on" type="file" class="hide" id="pictureFile" name="pictureFile" onchange="xmTanUploadImg(this)">
										更改头像
									</a>
								</td>
							</tr>
							<tr>
								...
								<td id="">
									<input type="text" placeholder="${sessionScope.session.userName }" id="textName" name="textName">
								</td>
							</tr>
							<tr>
								<td class="setting-title">电子邮件</td>
								<td>
									<span>835621887@qq.com</span>
									<!---->
								</td>
							</tr>
						</tbody>
						...
						<tbody class="information">
							...
							<tr>
								...
								<td class="weixin-qrcode">
									<img src="${pageContext.request.contextPath}/img/user.do?fileFileName=${sessionScope.session.userWechat }" id="selectImg2" alt="暂无">
									<a class="btn btn-hollow">
										<input type="file" class="hide" onchange="xmTanUploadImg2(this)" name="weCate">
										更换图片
									</a>
