		...
		<div class="row">
			<div class="col-xs-16 main">
				...
				<div id="list-container">
					<!-- 动态列表模块 -->
					<ul class="note-list" infinite-scroll-url="/users/b91cc2d507d0/timeline">

						<!-- 遍历用户发表了文章 -->
						<c:forEach items="${UALDTO.listA }" var="listA">
							<li class="have-img" id="feed-374866967">
								<a class="wrap-img" href="#">
									<img src="${pageContext.request.contextPath}/img/user.do?fileFileName=${listA.articleImg}" alt="120">
								</a>
								<div class="content">
									<div class="author">
										<a class="avatar" href="#">
											<img src="${pageContext.request.contextPath}/img/user.do?fileFileName=${UALDTO.user.userPortrait }" alt="180">
										</a>
										<div class="info">
											<a class="nickname" href="#">${UALDTO.user.userName }</a>
											<span data-type="share_note" data-datetime="2018-11-07T17:55:39+08:00"> 发表了文章 · ${listA.articleModifytime }</span>
										</div>
									</div>

									<a class="title" href="${pageContext.request.contextPath}/homePage/articleDetail.do?article_Id=${listA.articleId}" target="_blank">${listA.articleTitle }</a>
									...
									<div class="meta">
										...
										<c:choose>
											...
											<c:when test="${sessionScope.session.userId eq UALDTO.user.userId }">
												<button class="btn btn-delete" style="margin-left: 260px;" onclick="javascript:jj('${listA.articleId }');">
			...
			<div class="col-xs-7 col-xs-offset-1 aside">
				<ul class="list user-dynamic">
					<li class="badge-icon">
						<a target="_blank" href="/mobile/club">
							<img heigth="20" src="//upload.jianshu.io/user_badge/22d8d123-271c-4d80-9c59-6990844a9e37" alt="22d8d123 271c 4d80 9c59 6990844a9e37" width="20">
							会员
						</a>
					</li>
				</ul>
				...
				<div class="user-action">
					...
					·
					<a class="js-report-button" data-reportable-id="8972166" data-reportable-type="user">举报用户</a>
				</div>
			</div>
