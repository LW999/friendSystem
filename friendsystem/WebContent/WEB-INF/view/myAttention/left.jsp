...
<body>
		<div class="aside">
					...
					<ul class="js-subscription-list">
						<li class="">
							<a href="${pageContext.request.contextPath }/jump/attention。do" class="wrap">
								<div class="avatar"><img src="//upload.jianshu.io/users/upload_avatars/13213889/7314c5cc-ca7f-4542-b914-2c8dffaf324d.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/120/h/120"></div>
								<div class="name">friends</div>
								<!---->
							</a>
						</li>
						<li class="">
							<a href="#/subscriptions/13909018/user" class="wrap">
								<div class="avatar"><img src="//upload.jianshu.io/users/upload_avatars/13213889/7314c5cc-ca7f-4542-b914-2c8dffaf324d.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/120/h/120"></div>
								<div class="name">关注的专题</div>
								<!---->
							</a>
						</li>
						<li class="${pageContext.request.contextPath }/jump/recommend">
							<a href="" class="wrap">
								<div class="avatar"><img src="//upload.jianshu.io/users/upload_avatars/13213889/7314c5cc-ca7f-4542-b914-2c8dffaf324d.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/120/h/120"></div>
