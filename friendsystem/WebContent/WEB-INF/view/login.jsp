		...
		<div class="main">
			<h4 class="title">
				<div class="normal-title">
					<a class="active" href="${pageContext.request.contextPath }/jump/login.do">登录</a>
					<b>·</b>
					<a id="js-sign-up-btn" class="" href="${pageContext.request.contextPath }/jump/reg.do">注册</a>
				</div>
			</h4>
			<div class="js-sign-in-container">
				<form action="${pageContext.request.contextPath }/login/login.do" accept-charset="UTF-8" method="post">
					...
					<div class="input-prepend restyle js-normal">
						<input placeholder="账号或邮箱" name="account" type="text" class="form-control">
						<i class="iconfont ic-user"></i>
					</div>
					<div class="input-prepend">
						<input placeholder="密码" name="password" type="password" class="form-control">
